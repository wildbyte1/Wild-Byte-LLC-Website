...
const Footer = () => {
  ...
  return (
    <footer className='w-full bg-light text-tertiary py-12 px-6 border-t border-primary dark:bg-primary dark:text-white transition-colors duration-200'>
      <div className='max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6'>
        ...
        <div className='text-center md:text-left'>
          ...
          <p className='text-xs font-bold text-tertiary dark:text-stone-100 max-w-sm leading-relaxed'>
          ...
          <br />
          <p className='text-xs text-secondary dark:text-light font-medium italic max-w-sm leading-relaxed'>
      ...
      <div className='max-w-6xl mx-auto border-t border-secondary/30 dark:border-white/40 my-8'></div>
